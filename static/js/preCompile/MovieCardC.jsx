...
var SynopsisC = React.createClass({
   ...
   render: function () {
      var frebaseIsLoad = this.state.freebaseContent ?
         <div>
            <div className="uk-text-warning">
               <h5>Data provide by Freebase api</h5>
            </div>
            <p>{this.state.freebaseContent}</p>
         </div>
         :
         <div>Loading freebase data, please wait.....</div>
      ...
      if (this.state.content !== "") {
         tomat = (
            <div>
               <div className="uk-text-warning">
                  <h5>Data provide by Rotten Tomatoes api</h5>
               </div>
